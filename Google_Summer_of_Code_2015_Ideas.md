...
permalink: Google_Summer_of_Code_2015_Ideas
layout: wiki
---
...
then be more easily understood, shared and curated by other developers,
...
NoFlo-UI source code is available at this link
...
- Release the libraries in a modular and documented manner for reuse by
  others.
...
[bits](http://hackage.haskell.org/package/bits) for some bitwise
...
arrays](http://hackage.haskell.org/package/PrimitiveArray) and
[ADPfusion](http://hackage.haskell.org/package/ADPfusion).
